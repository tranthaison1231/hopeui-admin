  ...
  return (
    <div className="login w-full flex h-screen bg-[#FFFFFF] relative">
      ...
      <div className="form w-1/2 justify-center items-flex-start flex flex-col gap-10">
        ...
        <h2 className='Sitsc w-52 h-7 font-serif font-normal text-base leading-7 text-center order-1 text-[#8A92A6]'>Sign in to stay connected</h2>
        </div>
      ...
      <div className="form1 flex flex-col items-start gap-4 order-0">
        <div className="flex flex-col items-start gap-2 order-0">
            ...
            <label htmlFor="username" className="username flex flex-col items-start gap-4 order-1 w-[420px] h-11 ">
                <input type="text" className="username border-solid rounded-md border-[1px] border-box px-4 py-2 gap-56 w-[420px] h-11 bg-[#FFFF] order-0 border-[#3A57E8] focus:bg-blue-100 hover:bg-blue-100 focus:outline-none" />
            </label>
        </div>
        <div className="flex flex-col items-start gap-2 order-0">
            ...
            <label htmlFor="password" className="password flex flex-col items-start gap-4 order-1 w-[420px] h-11 ">
                <input type="password" className="password border-solid rounded-md border-[1px] border-box px-4 py-2 gap-56 w-[420px] h-11 bg-[#FFFF] order-0 border-[#3A57E8] focus:bg-blue-100 hover:bg-blue-100 focus:outline-none" />
            </label>
        </div>
        <div className="flex flex-row items-start p-0 gap-40 order-2 w-full">
            ...
            <p className="forgot font-serif font-normal text-base leading-7 text-[#3A57E8] order-0 cursor-pointer hover:text-[#131c49]">Forgot Password</p>
        </div>
      </div>
      <div className="signbutton flex flex-row justify-center items-center py-2 px-6 w-48 h-11 bg-[#3A57E8] rounded-[4px] order-1 cursor-pointer hover:bg-[#4a66f3]">
        <p className="font-serif font-normal text-base leading-7 flex items-center text-center text-[#FFFFFF]">Sign in</p>
        </div> 
    </div>
          </div>
        </div>
